...
{
    public partial class KayitOl2 : Form
    {
        public KayitOl2()
        {
            InitializeComponent();
        ...
        private void KayitOl2_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand komut = new SqlCommand("insert into Tbl_Kullanicilar2 (KullaniciAd,Sifre,apikey) values (@p1,@p2,@p3)", bgl.baglanti());
